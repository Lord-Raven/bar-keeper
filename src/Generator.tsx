...
export function buildAlcoholDescriptionsPrompt(stage: Stage): string {
    return (
        ...
        buildSection('Example Responses',
            `<START>\n{{char}}: NAME: Cherry Rotgut DESCRIPTION: A viscous, blood-red liqueur in a garishly bright bottle--tastes like cough syrup.\n` +
            ...
            `<START>\n{{char}}: NAME: Classic Grog DESCRIPTION: Cheap rum cut with water and lime juice until it barely tastes like anything, served in a sandy bottle.\n` +
